...
M.highlights_base = function(colors)
	return {
		...
		Comment = { fg = colors.color1, italic = false, bold = false },
		...
		Constant = { fg = colors.color14, italic = false },
		Number = { fg = colors.color6 },
		Boolean = { fg = colors.color4, italic = false },
		Float = { fg = colors.color5 },
		Identifier = { fg = colors.color5 },
		Function = { fg = colors.color8, bold = true, italic = false },
		...
		TSVariableBuiltin = { fg = colors.color14, italic = false }, -- Variable names that are defined by the languages, like `this` or `self`.
		...
		DiagnosticError = { fg = colors.color8 },
		DiagnosticWarn = { fg = colors.color9 },
		DiagnosticInfo = { fg = colors.color4 },
		DiagnosticHint = { fg = colors.color7 },
